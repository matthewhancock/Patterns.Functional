using System;
using static Patterns.Functional.Types.Util.OneOf;
...
namespace Patterns.Functional.Types {
    public struct OneOf<T1, T2> {
        ...
        public TResult As<TResult>() {
            ...
            throw GetTypeMismatchException();
        }
        ...
        public static implicit operator T1(OneOf<T1, T2> OneOfValue) => OneOfValue.Type == OneOfTypeEnum.T1 ? OneOfValue.Value1 : throw GetTypeMismatchException();
        public static implicit operator T2(OneOf<T1, T2> OneOfValue) => OneOfValue.Type == OneOfTypeEnum.T2 ? OneOfValue.Value2 : throw GetTypeMismatchException();
        ...
        private static Exception GetTypeMismatchException() => new Exception("Requested Type does not match Value");
    }
}
