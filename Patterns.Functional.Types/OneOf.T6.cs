...
namespace Patterns.Functional.Types {
    public struct OneOf<T1, T2, T3, T4, T5, T6> : IOneOf<T1, T2, T3, T4, T5, T6>, IOneOf {
        ...
        T1 IOneOf<T1, T2, T3, T4, T5, T6>.Value1 => Value1;
        T2 IOneOf<T1, T2, T3, T4, T5, T6>.Value2 => Value2;
        T3 IOneOf<T1, T2, T3, T4, T5, T6>.Value3 => Value3;
        T4 IOneOf<T1, T2, T3, T4, T5, T6>.Value4 => Value4;
        T5 IOneOf<T1, T2, T3, T4, T5, T6>.Value5 => Value5;
        T6 IOneOf<T1, T2, T3, T4, T5, T6>.Value6 => Value6;
