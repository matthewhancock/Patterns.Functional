...
namespace Patterns.Functional.Types {
    public struct OneOf<T1, T2, T3, T4, T5> : IOneOf<T1, T2, T3, T4, T5>, IOneOf {
        ...
        T1 IOneOf<T1, T2, T3, T4, T5>.Value1 => Value1;
        T2 IOneOf<T1, T2, T3, T4, T5>.Value2 => Value2;
        T3 IOneOf<T1, T2, T3, T4, T5>.Value3 => Value3;
        T4 IOneOf<T1, T2, T3, T4, T5>.Value4 => Value4;
        T5 IOneOf<T1, T2, T3, T4, T5>.Value5 => Value5;
        ...
        public static implicit operator T1(OneOf<T1, T2, T3, T4, T5> OneOfValue)
            => OneOfValue.Type == OneOfTypeEnum.T1 ? OneOfValue.Value1 : throw new OneOfTypeMismatchException();
        public static implicit operator T2(OneOf<T1, T2, T3, T4, T5> OneOfValue)
            => OneOfValue.Type == OneOfTypeEnum.T2 ? OneOfValue.Value2 : throw new OneOfTypeMismatchException();
        public static implicit operator T3(OneOf<T1, T2, T3, T4, T5> OneOfValue)
            => OneOfValue.Type == OneOfTypeEnum.T3 ? OneOfValue.Value3 : throw new OneOfTypeMismatchException();
        public static implicit operator T4(OneOf<T1, T2, T3, T4, T5> OneOfValue)
            => OneOfValue.Type == OneOfTypeEnum.T4 ? OneOfValue.Value4 : throw new OneOfTypeMismatchException();
        public static implicit operator T5(OneOf<T1, T2, T3, T4, T5> OneOfValue)
            => OneOfValue.Type == OneOfTypeEnum.T5 ? OneOfValue.Value5 : throw new OneOfTypeMismatchException();

        public static implicit operator OneOf<T1, T2, T3, T4, T5>(T1 OneOfValue) => new(OneOfValue);
        public static implicit operator OneOf<T1, T2, T3, T4, T5>(T2 OneOfValue) => new(OneOfValue);
        public static implicit operator OneOf<T1, T2, T3, T4, T5>(T3 OneOfValue) => new(OneOfValue);
        public static implicit operator OneOf<T1, T2, T3, T4, T5>(T4 OneOfValue) => new(OneOfValue);
        public static implicit operator OneOf<T1, T2, T3, T4, T5>(T5 OneOfValue) => new(OneOfValue);
    }
}
